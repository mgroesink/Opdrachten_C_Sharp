...
namespace Opdrachten_C_Sharp.Controllers
{
    public class Opdracht7Controller : Controller
    {
        ...
        public IActionResult Opdracht7_13()
        {
            /*
            Schrijf een programma waarbij de gebruiker een wachtwoord opgeeft en een key. 
            •	als key gebruiken we een random string die even lang is 
                als de te versleutelen tekst.
        ...
        [HttpPost]
        public IActionResult Opdracht7_13(string password = "")
        {
            ViewBag.Password = password;
            string key = RandomKey(password.Length);
        ...
        {
            string chars = "abcdefghijklmnopqrstuvwxyz" + "abcdefghijklmnopqrstuvwxyz".ToUpper() +
                "0123456789";
            Random r = new Random();
